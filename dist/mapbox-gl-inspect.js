...
function isInspectStyle(style) {
  return style.metadata && style.metadata['inspect'];
}

function markInspectStyle(style) {
  style.metadata = style.metadata || {};
  style.metadata.inspect = true;
  return style;
}
...
MapboxInspect.prototype.render = function () {
  if (this._showInspectMap) {
    ...
    this._map.setStyle(fixStyle(markInspectStyle(this._originalStyle)));
